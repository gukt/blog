...
// 通过泛型类型参数来定义组件属性往往更直接，如果属性比较多，也可以单独先定义一个类型，然后在 defineProps 里面引用这个类型，具体可以参考下面的代码，参考文档：https://cn.vuejs.org/guide/typescript/composition-api.html#using-script-setup
// interface Props {
//   foo: string
//   bar?: number
// }
