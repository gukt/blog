...
const projects = [
  {
    slug: 'card-this',
    img: '/images/blog/blog-post-1.webp',
  ...
  {
    slug: 'project-2',
    img: '/images/blog/blog-post-2.webp',
  ...
  {
    slug: 'project-3',
    img: '/images/blog/blog-post-3.webp',
    title: '我为什么写博客',
    subtitle:
  ...
  {
    slug: 'project-4',
    img: '/images/blog/blog-post-4.webp',
    title: '又去打工出卖时间和自由了!',
    subtitle:
    ...
    <div class="container max-w-4xl py-6 lg:py-10">
      ...
      >
        <div class="flex-1 space-y-4">
          ...
          <h1 class="font-heading leading-[1.1] text-2xl md:text-3xl font-bold">
            博客
          </h1>
      ...
      <div class="grid gap-10 sm:grid-cols-2">
        ...
        >
          ...
          <p class="text-[0.9rem] text-muted-foreground line-clamp-2">
            {{ project.subtitle }}
          </p>
          <time class="text-sm text-muted-foreground">April 9, 2023</time>
      ...
      >
        <div class="space-y-4">
          <h1 class="font-heading leading-[1.1] text-2xl sm:text-3xl">
            我的博客
          </h1>
          <p
