...
<template>
  ...
  <NuxtLayout>
    <!-- BIO -->
    <!-- OLD: mt-8 -->
    <section class="pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
      <BioBlock
        class="container max-w-[64rem]"
    ...
    >
      ...
      >
        ...
        >
          我写的一些垃圾代码、玩具以及垃圾项目，如果你有兴趣，可以看看。我写的一些垃圾代码、玩具以及垃圾项目，如果你有兴趣，可以看看。
    ...
    <section class="container my-16">
      <h2 class="max-w-[56rem] text-3xl font-bold opacity-90 hover:opacity-100">
